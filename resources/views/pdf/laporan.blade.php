...
<body>
   ...
   <div class="text-center">
      <img src="{{ public_path('img/download.png') }}" class="img" alt="logo.png" width="90">
      <div style="margin-left:6rem;">
         <span class="text-header text-bold text-danger">
            YAYASAN NURUL ILMA <br> SEKOLAH MENENGAH KEJURUAN (SMK) <br>BINA INFORMATIKA <br>
         </span>
         <span class="text-desc">Jalan Pahlawan Nomor 33 Empang Kota Bogor Telepon 0857622393<br> Website <span class="underline">www.smkbifor.sch.id</span> </span>
      </div>    
      </div>
   <div>
   <!-- /header -->
