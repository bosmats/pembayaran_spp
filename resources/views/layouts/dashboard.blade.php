...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('assets/images/users/bifor.png') }}">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="{{ url('/dashboard') }}">                                            
                        <!-- Logo text -->
                        <span><img src="{{ url('assets/images/users/bifor.png') }}" alt="users" width="40" />                          
						<i class=""></i> Pembayaran SPP                             
                        </span>
                    </a>
                    <!-- ============================================================== -->
                    <!-- End Logo -->
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li>
                            ...
                            <div class="user-profile d-flex no-block dropdown m-t-20">
                                <div class="user-pic"><img src="{{ url('assets/images/users/kiw.jpg') }}" alt="users" class="rounded-circle" width="40" /></div>
